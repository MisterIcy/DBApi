// <copyright file="DropDatabase.cs">
...
{
    public class DropDatabase : Expression
    {
        [PublicAPI]
        public string DatabaseName { get; protected set; }
        
        public DropDatabase(string database) : base(-200)
        {
            DatabaseName = string.IsNullOrEmpty(database)
