// <copyright file="TableAttribute.cs">
...
{
    /// <summary>
    /// Annotates an Entity and associates it with a database Table
    /// </summary>
    ...
    public class TableAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="tableName">The name of the database table associated with this entity</param>
        /// <exception cref="ArgumentNullException">Thrown when the tableName is null or empty</exception>
        ...
        /// <summary>
        /// Gets a value that indicates the name of the table which is associated with the entity
        /// </summary>
        [NotNull]
